...
const OurProjects = () => {
  ...
  return (
    <main className="p-8 lg:px-24 bg-logo bg-black font-sans">
          ...
          <div className="mt-20" id="tower-3">
            ...
            >
              ...
              <p className="mt-3 text-xl md:text-2xl text-justify text-white">
                Get ready to upgrade your life with B&B Builders&apos; future
                masterpiece, Tower 3! This architectural masterpiece, located in
                the heart of Boulevard Faisal Hills, Islamabad, elegantly mixes
                the greatest of commercial and residential facilities over a
                broad 1 kanal covered space. Tower 3 is more than simply a
                structure; it&apos;s a way of life designed for residents who
                value quality and comfort. B&B Tower 3 welcomes you to make your
                dream lifestyle a reality with ease by offering a fascinating
                ...
                fire-fighting tools, so ensuring safety is essential. The
        ...
        <div id="tower-2">
          ...
          >
            ...
            <p className="mt-3 text-xl md:text-2xl text-justify text-white">
              ...
              Enjoy a variety of amenities, such as a broad range of
              ...
              and power backup. At B&B Tower 2, where innovation meets luxury,
              you can raise your standards and embrace the future of unified
              living.
            </p>
            {/* Apartment Cards Section */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
