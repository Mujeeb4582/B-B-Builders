...
const RecentProject = () => {
  return (
    <>
      <div className="flex flex-col lg:flex-row items-center pl-24 lg:pl-24 p-12 ">
        <div className="w-full sm:w-1/3">
          <RecentSlider />
        </div>
        <div className="text-center lg:text-left p-12 pl-24 sm:w-1/2 w-full">
          <h1 className="text-2xl lg:text-4xl font-bold mb-4 lg:mb-8 text-[#c86500]">
            Project Name
          </h1>
          <p className="text-base lg:text-lg mb-4 lg:mb-2 text-[#c86500]">
